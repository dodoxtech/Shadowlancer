...
const messages: Message[] = [
  {
    ...
    preview:
      "The protocol designs look incredible, Hacker. Can we jump on a quick call tomorrow?",
    time: "14:02",
    avatarSrc:
  ...
  },
  {
    ...
    sender: "David Chen",
    preview:
      "I've sent the initial deposit to your Shadowlancer wallet. Please confirm receipt.",
    time: "Yesterday",
    avatarSrc:
  ...
  return (
    <>
      ...
      <main className="pt-32 pb-20 px-8 max-w-[1440px] mx-auto flex-1">
        <WelcomeHeader userName="Hacker" walletBalance="0.842 ETH" />
